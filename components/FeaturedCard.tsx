...
export default function FeaturedCard({ listing }: { listing: Listing }) {
  ...
  return (
    <Link
      ...
      className={`block rounded-lg border bg-white overflow-hidden active:scale-[0.98] transition-all ${
    ...
    >
      <div className="aspect-square bg-canvas2 relative">
        ...
        {verified && (
          <span className="absolute top-1.5 right-1.5 w-5 h-5 rounded-full bg-navy flex items-center justify-center">
